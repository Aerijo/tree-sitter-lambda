...
enum {
  anon_sym_GT = 1,
  anon_sym_EQ = 2,
  aux_sym_SLASH_GT_GT_GT_PLUS_SLASH = 3,
  aux_sym_SLASH_LT_LT_LT_PLUS_SLASH = 4,
  anon_sym_SEMI = 5,
  anon_sym_LPAREN = 6,
  anon_sym_RPAREN = 7,
  anon_sym_LBRACK = 8,
  ...
  anon_sym_COLON = 26,
  anon_sym_LBRACE = 27,
  aux_sym_SLASH_LBRACK_CARET_RBRACE_BSLASHn_RBRACK_STAR_SLASH = 28,
  anon_sym_RBRACE = 29,
  anon_sym_DQUOTE_DQUOTE_DQUOTE = 30,
  aux_sym_SLASH_LBRACK_CARET_DQUOTE_RBRACK_SLASH = 31,
  aux_sym_SLASH_DQUOTE_LBRACK_CARET_DQUOTE_RBRACK_SLASH = 32,
  aux_sym_SLASH_DQUOTE_DQUOTE_LBRACK_CARET_DQUOTE_RBRACK_SLASH = 33,
  anon_sym_SQUOTE_SQUOTE_SQUOTE = 34,
  aux_sym_SLASH_LBRACK_CARET_SQUOTE_RBRACK_SLASH = 35,
  aux_sym_SLASH_SQUOTE_LBRACK_CARET_SQUOTE_RBRACK_SLASH = 36,
  aux_sym_SLASH_SQUOTE_SQUOTE_LBRACK_CARET_SQUOTE_RBRACK_SLASH = 37,
  anon_sym_COLON_EQ = 38,
  anon_sym_SLASH = 39,
  anon_sym_PIPE = 40,
  anon_sym_LT_DASH = 41,
  sym_identifier = 42,
  sym_func_identifier = 43,
  sym_line_comment = 44,
  ...
  sym_block_tag = 66,
  sym_annotation = 67,
  sym_replace_forwards = 68,
  sym_replace_backwards = 69,
  aux_sym_program_repeat1 = 70,
  aux_sym__block_contents_repeat1 = 71,
  aux_sym_block_expression_repeat1 = 72,
  aux_sym_function_repeat1 = 73,
  aux_sym_annotation_repeat1 = 74,
  aux_sym_annotation_repeat2 = 75,
  anon_alias_sym_expression = 76,
};
...
static const char *ts_symbol_names[] = {
  ...
  [anon_sym_GT] = ">",
  [anon_sym_EQ] = "=",
  [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = "/>>>+/",
  [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = "/<<<+/",
  [anon_sym_SEMI] = ";",
  [anon_sym_LPAREN] = "(",
  [anon_sym_RPAREN] = ")",
  [anon_sym_LBRACK] = "[",
  ...
  [anon_sym_COLON] = ":",
  [anon_sym_LBRACE] = "{",
  [aux_sym_SLASH_LBRACK_CARET_RBRACE_BSLASHn_RBRACK_STAR_SLASH] = "/[^}\\n]*/",
  [anon_sym_RBRACE] = "}",
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 37:
      ...
      END_STATE();
    case 38:
      ACCEPT_TOKEN(aux_sym_SLASH_LT_LT_LT_PLUS_SLASH);
      if (lookahead == '<')
        ADVANCE(38);
      END_STATE();
    case 39:
    ...
    case 45:
      ...
      END_STATE();
    case 46:
      ACCEPT_TOKEN(aux_sym_SLASH_GT_GT_GT_PLUS_SLASH);
      if (lookahead == '>')
        ADVANCE(46);
      END_STATE();
    case 47:
    ...
    case 102:
      ...
      END_STATE();
    case 103:
      ACCEPT_TOKEN(aux_sym_SLASH_LBRACK_CARET_RBRACE_BSLASHn_RBRACK_STAR_SLASH);
      if (lookahead == '\n')
        SKIP(103);
      if (lookahead == '-')
        ADVANCE(104);
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(1),
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(1),
  ...
  [1] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(9),
  ...
  [3] = {
    ...
    [sym_block_tag] = STATE(27),
    [sym_annotation] = STATE(28),
    [aux_sym__block_contents_repeat1] = STATE(28),
    [aux_sym_block_expression_repeat1] = STATE(29),
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(34),
    [anon_sym_LPAREN] = ACTIONS(36),
    [sym__newline] = ACTIONS(38),
    [anon_sym_EQ_EQ] = ACTIONS(40),
    [anon_sym_EQ1] = ACTIONS(40),
    [anon_sym_EQ2] = ACTIONS(40),
    [anon_sym_a_EQ] = ACTIONS(40),
    [anon_sym_EQa] = ACTIONS(40),
    [anon_sym_EQ_GT] = ACTIONS(42),
    [anon_sym_EQ3] = ACTIONS(42),
    [anon_sym_EQ4] = ACTIONS(42),
    [anon_sym_b_EQ] = ACTIONS(42),
    [anon_sym_EQb] = ACTIONS(42),
  ...
  [11] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(83),
  ...
  [18] = {
    ...
    [sym_func_identifier] = ACTIONS(111),
    [sym_line_comment] = ACTIONS(32),
    [sym_block_comment] = ACTIONS(32),
  ...
  [19] = {
    [aux_sym_SLASH_LBRACK_CARET_RBRACE_BSLASHn_RBRACK_STAR_SLASH] = ACTIONS(115),
    [sym_line_comment] = ACTIONS(52),
    [sym_block_comment] = ACTIONS(52),
  },
  [20] = {
  ...
  [22] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(123),
    [sym_line_comment] = ACTIONS(32),
    [sym_block_comment] = ACTIONS(32),
  },
  [23] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(125),
    [anon_sym_SEMI] = ACTIONS(127),
    [anon_sym_LPAREN] = ACTIONS(125),
    [sym__newline] = ACTIONS(129),
    [anon_sym_EQ_EQ] = ACTIONS(125),
    [anon_sym_EQ1] = ACTIONS(125),
    [anon_sym_EQ2] = ACTIONS(125),
    [anon_sym_a_EQ] = ACTIONS(125),
    [anon_sym_EQa] = ACTIONS(125),
    [anon_sym_EQ_GT] = ACTIONS(125),
    [anon_sym_EQ3] = ACTIONS(125),
    [anon_sym_EQ4] = ACTIONS(125),
    [anon_sym_b_EQ] = ACTIONS(125),
    [anon_sym_EQb] = ACTIONS(125),
  ...
  [25] = {
    [sym_beta_replacement] = STATE(57),
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(85),
    [anon_sym_SEMI] = ACTIONS(85),
    [anon_sym_LPAREN] = ACTIONS(85),
  ...
  [26] = {
    [sym_func_sep] = STATE(59),
    [aux_sym_function_repeat1] = STATE(60),
  ...
  [27] = {
    ...
    [aux_sym__block_contents_repeat1] = STATE(28),
    [aux_sym_block_expression_repeat1] = STATE(29),
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(141),
    [anon_sym_LPAREN] = ACTIONS(36),
    [sym__newline] = ACTIONS(38),
    [anon_sym_EQ_EQ] = ACTIONS(40),
    [anon_sym_EQ1] = ACTIONS(40),
  ...
  [28] = {
    ...
    [aux_sym_block_expression_repeat1] = STATE(29),
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(143),
    [anon_sym_LPAREN] = ACTIONS(36),
  ...
  [29] = {
    ...
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(147),
  ...
  [30] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(153),
  ...
  [34] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(164),
  ...
  [45] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(213),
  ...
  [47] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(185),
    [anon_sym_SEMI] = ACTIONS(185),
    [anon_sym_LPAREN] = ACTIONS(185),
    [anon_sym_LBRACK] = ACTIONS(185),
    [sym__newline] = ACTIONS(187),
  ...
  [50] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(153),
  ...
  [53] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(236),
  ...
  [55] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(242),
  ...
  [57] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(197),
    [anon_sym_SEMI] = ACTIONS(197),
    [anon_sym_LPAREN] = ACTIONS(197),
    [anon_sym_LBRACK] = ACTIONS(197),
    [sym__newline] = ACTIONS(199),
  ...
  [58] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(201),
    [anon_sym_SEMI] = ACTIONS(201),
    [anon_sym_LPAREN] = ACTIONS(201),
    [anon_sym_LBRACK] = ACTIONS(201),
    [sym__newline] = ACTIONS(203),
  ...
  [59] = {
    ...
    [sym_group] = STATE(25),
    [sym_function] = STATE(25),
    [sym_func_body] = STATE(88),
    [sym__terminal] = STATE(25),
    [sym_func_indicator] = STATE(26),
    [aux_sym_block_expression_repeat1] = STATE(89),
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(205),
    [anon_sym_SEMI] = ACTIONS(205),
    [anon_sym_LPAREN] = ACTIONS(36),
    [anon_sym_LBRACK] = ACTIONS(205),
    [sym__newline] = ACTIONS(207),
  ...
  [61] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(248),
    [sym_line_comment] = ACTIONS(32),
    [sym_block_comment] = ACTIONS(32),
  },
  [62] = {
    ...
    [aux_sym__block_contents_repeat1] = STATE(62),
    [aux_sym_block_expression_repeat1] = STATE(29),
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(250),
  ...
  [63] = {
    ...
    [sym_func_indicator] = STATE(26),
    [aux_sym_block_expression_repeat1] = STATE(63),
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(215),
    [anon_sym_SEMI] = ACTIONS(215),
  ...
  [64] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(284),
  ...
  [67] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(298),
  ...
  [83] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(302),
    [anon_sym_SEMI] = ACTIONS(302),
    [anon_sym_LPAREN] = ACTIONS(302),
    [anon_sym_LBRACK] = ACTIONS(302),
    [sym__newline] = ACTIONS(304),
  ...
  [84] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(339),
  ...
  [85] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(284),
  ...
  [86] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(343),
    [anon_sym_LPAREN] = ACTIONS(343),
    [sym__newline] = ACTIONS(345),
    [anon_sym_EQ_EQ] = ACTIONS(343),
    [anon_sym_EQ1] = ACTIONS(343),
    [anon_sym_EQ2] = ACTIONS(343),
    [anon_sym_a_EQ] = ACTIONS(343),
    [anon_sym_EQa] = ACTIONS(343),
    [anon_sym_EQ_GT] = ACTIONS(343),
    [anon_sym_EQ3] = ACTIONS(343),
    [anon_sym_EQ4] = ACTIONS(343),
    [anon_sym_b_EQ] = ACTIONS(343),
    [anon_sym_EQb] = ACTIONS(343),
    [anon_sym_BSLASH] = ACTIONS(343),
    [anon_sym_1] = ACTIONS(343),
    [anon_sym_lambda] = ACTIONS(343),
    [anon_sym_DQUOTE_DQUOTE_DQUOTE] = ACTIONS(343),
    [anon_sym_SQUOTE_SQUOTE_SQUOTE] = ACTIONS(343),
    [sym_identifier] = ACTIONS(343),
    [sym_func_identifier] = ACTIONS(343),
    [sym_line_comment] = ACTIONS(52),
    [sym_block_comment] = ACTIONS(52),
  ...
  [88] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(326),
    [anon_sym_SEMI] = ACTIONS(326),
    [anon_sym_LPAREN] = ACTIONS(326),
    [anon_sym_LBRACK] = ACTIONS(326),
    [sym__newline] = ACTIONS(328),
  ...
  [89] = {
    ...
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(330),
    [anon_sym_SEMI] = ACTIONS(330),
    [anon_sym_LPAREN] = ACTIONS(36),
    [anon_sym_LBRACK] = ACTIONS(330),
    [sym__newline] = ACTIONS(332),
  ...
  [91] = {
    ...
    [aux_sym_SLASH_GT_GT_GT_PLUS_SLASH] = ACTIONS(349),
  ...
  [106] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(359),
    [anon_sym_SEMI] = ACTIONS(359),
    [anon_sym_LPAREN] = ACTIONS(359),
    [anon_sym_LBRACK] = ACTIONS(359),
    [sym__newline] = ACTIONS(361),
  ...
  [120] = {
    [aux_sym_SLASH_LT_LT_LT_PLUS_SLASH] = ACTIONS(371),
    [anon_sym_SEMI] = ACTIONS(371),
    [anon_sym_LPAREN] = ACTIONS(371),
    [anon_sym_LBRACK] = ACTIONS(371),
    [sym__newline] = ACTIONS(373),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [101] = {.count = 1, .reusable = true}, REDUCE(sym_block, 2),
  [103] = {.count = 1, .reusable = false}, REDUCE(sym_block, 2),
  [105] = {.count = 1, .reusable = true}, SHIFT(47),
  [107] = {.count = 1, .reusable = true}, REDUCE(sym_alpha_convert, 1),
  [109] = {.count = 1, .reusable = false}, REDUCE(sym_alpha_convert, 1),
  [111] = {.count = 1, .reusable = true}, REDUCE(sym_beta_reduce, 1),
  [113] = {.count = 1, .reusable = false}, REDUCE(sym_beta_reduce, 1),
  ...
  [125] = {.count = 1, .reusable = false}, REDUCE(aux_sym__block_contents_repeat1, 1, .alias_sequence_id = 1),
  ...
  [167] = {.count = 2, .reusable = true}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(34),
  ...
  [238] = {.count = 1, .reusable = false}, REDUCE(aux_sym__block_contents_repeat1, 2, .alias_sequence_id = 1),
  [240] = {.count = 1, .reusable = true}, REDUCE(aux_sym__block_contents_repeat1, 2, .alias_sequence_id = 1),
  [242] = {.count = 1, .reusable = false}, REDUCE(aux_sym__block_contents_repeat1, 2, .alias_sequence_id = 2),
  [244] = {.count = 1, .reusable = false}, SHIFT(86),
  [246] = {.count = 1, .reusable = true}, REDUCE(aux_sym__block_contents_repeat1, 2, .alias_sequence_id = 2),
  [248] = {.count = 1, .reusable = true}, SHIFT(91),
  [250] = {.count = 1, .reusable = false}, REDUCE(aux_sym__block_contents_repeat1, 2),
  [252] = {.count = 2, .reusable = false}, REDUCE(aux_sym__block_contents_repeat1, 2), SHIFT_REPEAT(16),
  [255] = {.count = 2, .reusable = true}, REDUCE(aux_sym__block_contents_repeat1, 2), SHIFT_REPEAT(62),
  [258] = {.count = 2, .reusable = false}, REDUCE(aux_sym__block_contents_repeat1, 2), SHIFT_REPEAT(17),
  [261] = {.count = 2, .reusable = false}, REDUCE(aux_sym__block_contents_repeat1, 2), SHIFT_REPEAT(18),
  ...
  [273] = {.count = 2, .reusable = false}, REDUCE(aux_sym__block_contents_repeat1, 2), SHIFT_REPEAT(25),
  [276] = {.count = 2, .reusable = false}, REDUCE(aux_sym_block_expression_repeat1, 2), SHIFT_REPEAT(16),
  [279] = {.count = 2, .reusable = false}, REDUCE(aux_sym_block_expression_repeat1, 2), SHIFT_REPEAT(25),
  ...
  [343] = {.count = 1, .reusable = false}, REDUCE(aux_sym__block_contents_repeat1, 3, .alias_sequence_id = 2),
  [345] = {.count = 1, .reusable = true}, REDUCE(aux_sym__block_contents_repeat1, 3, .alias_sequence_id = 2),
  [347] = {.count = 1, .reusable = true}, REDUCE(sym_block, 4),
  [349] = {.count = 1, .reusable = false}, REDUCE(sym_block, 4),
